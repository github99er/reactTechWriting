...
export default function MyCardThree() {
  ...
  return (
    <div id="MyCard" className="headertext">
      ...
      >
        <CardHeader
          title="Utilizing SingularityNET to Minimize Recommendation Fraud in Online Marketplaces"
          style={{ backgroundColor: "#20232a", color: "#fff" }}
        />
        <CardMedia
          style={{ backgroundColor: "#20232a", color: "#fff" }}
        ...
        <CardActions disableSpacing>
          <IconButton
            href="https://blog.singularitynet.io/minimizing-recommendation-fraud-7dabbee8fc00"
            target="_blank"
            aria-label="GitHub"
            style={{ backgroundColor: "#20232a", color: "#fff" }}
          >
